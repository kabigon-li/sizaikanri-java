	...
	<form name="requestdetailform"
		...
		<table class="inputtable">
			...
			<tr>
				...
				<td><textarea rows="6" cols="30" name="form.sizai.note"
						class="seigyo" ></textarea></td>
			</tr>

			<tr>
				<td><label>購入理由</label></td>
				<td><textarea rows="6" cols="30" name="form.sizai.buy_reason"
						class="seigyo" ></textarea></td>
			</tr>

			<tr>
				<td><label>却下理由</label></td>
				<td><textarea rows="6" cols="30" name="form.sizai.dele_reason"
						></textarea></td>
			</tr>

		</table>

		<input type="submit" value="却下" /> <a
